...
const HeroSection = () => {
  ...
  return (
    <div className='flex flex-col items-start justify-center gap-4 px-6 md:px-16 lg:px-36 bg-[url("/backgroundImage.png")] bg-cover bg-center h-screen'>
      ...
      <img src={assets.marvelLogo} alt="" className="max-h-11 lg:h-11 mt-12" />
      ...
      <div className="flex flex-wrap items-center gap-x-4 gap-y-1 text-gray-300 text-sm">
        <span className="whitespace-nowrap">Action | Adventure | Sci-Fi</span>
